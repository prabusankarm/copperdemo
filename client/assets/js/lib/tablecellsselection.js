...
(function($, window, document, undefined) {
    ...
    function selectCells($table, data) {
        ...
        var tabl_val = $('#tablecellsselection .tcs-selected:last');
        var selctval = tabl_val.text();
        var tempStringval = selctval.split(",");
            selectedCellsSTyle(tempStringval);
        ...
        function selectedCellsSTyle(tempString){
            ...
            console.log(selctval);
        $('#output').val(tempStringval[0]+"x"+tempStringval[1]);
